...
class Loader:
    ...
    def get_model_connection(self, model_name):
        cursor = self.get_cursor()

        # get the application id and base path
        query = f"SELECT host, port FROM models WHERE name = '{model_name}' LIMIT 1"
